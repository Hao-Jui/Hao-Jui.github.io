...
\newcommand{\hk}[1]{\textcolor{RedOrange}{#1}}
...
\begin{tabbing}
  ...
  \> Email/web\hspace{4.3mm}: \> hao-jui.kuan@aei.mpg.de / \href{https://hao-jui.github.io}{\textbf{\textcolor{Magenta}{hao-jui.github.io}}}\\
...
\begin{tabbing}
  \hspace*{5mm} \= \hspace*{2.3cm} \= \hspace*{10cm} \\[-3ex]
  \> 2025 - \> Research scholar at Illinois Center for Advanced Studies of the Universe \& University of Illinois \\
  \> \> Urbana-Champaign, United States. \textit{Mentor: Nicolas Yunes, Jacquelyn Noronha-Hostler}. \\
  \> 2023 - 2025 \> Postdoc in the Computational Relativistic Astrophysics division at the Max Planck Institute \\
  \> \> for Gravitational Physics (Albert Einstein Institute), Germany. \textit{Mentor: Masaru Shibata}.
\end{tabbing}
...
\begin{tabbing}
  ...
  \> \> Ph.D. in Theoretical Astrophysics.  Summa Cum Laude (excellent;  $\lesssim$~1 in 50 graduates). \\[1ex]
...
\begin{tabbing}
  \hspace*{5mm} \= \hspace*{2.3cm} \= \hspace*{10cm} \\[-3ex]
  \> {\bf Journals} \> Physical Review Letter, Physical Review D, International Journal of Modern Physics D, \\
...
\begin{tabbing}
  ...
  \> June 17 \> ``\textbf{Tidal Resonance in Binary Neutron Star Mergers -- Numerical Relativity Insights}'', \\
...
\begin{tabbing}
  ...
  %
  \> {\bf 2025} \> \\[1ex]
  \> July 24 \> ``\textbf{Tidal Resonance in Binary Neutron Star Mergers}'',\\
...
\begin{tabbing}
  \hspace*{15mm} \= \hspace*{2.8cm} \= \hspace*{10cm} \\[-3ex]
...
\,\,\,{\Large \bf Outreach lecturing}
\begin{tabbing}
  \hspace*{15mm} \= \hspace*{2.8cm} \= \hspace*{10cm} \\[-3ex]
  \> Black hole lectures at \textbf{Jürgen Ehlers Spring School}, Potsdam, March 3--14, 2025.
\end{tabbing}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
